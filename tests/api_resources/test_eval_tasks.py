...
from llama_stack_client.types import EvalTaskDefWithProvider
...
class TestEvalTasks:
    ...
    def test_method_retrieve(self, client: LlamaStackClient) -> None:
        ...
        assert_matches_type(Optional[EvalTaskDefWithProvider], eval_task, path=["response"])
    ...
    def test_method_list(self, client: LlamaStackClient) -> None:
        ...
        assert_matches_type(EvalTaskDefWithProvider, eval_task, path=["response"])
