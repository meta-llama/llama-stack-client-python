...
class TestTelemetry:
    ...
    @parametrize
    def test_method_query_span_tree(self, client: LlamaStackClient) -> None:
        telemetry = client.telemetry.query_span_tree(
            span_id="span_id",
        )
        assert_matches_type(TelemetryQuerySpanTreeResponse, telemetry, path=["response"])

    @parametrize
    def test_method_query_span_tree_with_all_params(self, client: LlamaStackClient) -> None:
        telemetry = client.telemetry.query_span_tree(
            span_id="span_id",
    ...
    @parametrize
    def test_raw_response_query_span_tree(self, client: LlamaStackClient) -> None:
        response = client.telemetry.with_raw_response.query_span_tree(
            span_id="span_id",
        )
    ...
    @parametrize
    def test_streaming_response_query_span_tree(self, client: LlamaStackClient) -> None:
        with client.telemetry.with_streaming_response.query_span_tree(
            span_id="span_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    def test_path_params_query_span_tree(self, client: LlamaStackClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `span_id` but received ''"):
            client.telemetry.with_raw_response.query_span_tree(
                span_id="",
            )
...
class TestAsyncTelemetry:
    ...
    @parametrize
    async def test_method_query_span_tree(self, async_client: AsyncLlamaStackClient) -> None:
        telemetry = await async_client.telemetry.query_span_tree(
            span_id="span_id",
        )
        assert_matches_type(TelemetryQuerySpanTreeResponse, telemetry, path=["response"])

    @parametrize
    async def test_method_query_span_tree_with_all_params(self, async_client: AsyncLlamaStackClient) -> None:
        telemetry = await async_client.telemetry.query_span_tree(
            span_id="span_id",
            attributes_to_return=["string"],
            max_depth=0,
    ...
    @parametrize
    async def test_raw_response_query_span_tree(self, async_client: AsyncLlamaStackClient) -> None:
        response = await async_client.telemetry.with_raw_response.query_span_tree(
            span_id="span_id",
        )
    ...
    @parametrize
    async def test_streaming_response_query_span_tree(self, async_client: AsyncLlamaStackClient) -> None:
        async with async_client.telemetry.with_streaming_response.query_span_tree(
            span_id="span_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    async def test_path_params_query_span_tree(self, async_client: AsyncLlamaStackClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `span_id` but received ''"):
            await async_client.telemetry.with_raw_response.query_span_tree(
                span_id="",
            )
