...
from llama_stack_client.types import ScoreResponse, ScoreBatchResponse
...
class TestScoring:
    ...
    def test_method_score(self, client: LlamaStackClient) -> None:
        ...
        assert_matches_type(ScoreResponse, scoring, path=["response"])
    ...
    def test_method_score_batch(self, client: LlamaStackClient) -> None:
        ...
        assert_matches_type(ScoreBatchResponse, scoring, path=["response"])
