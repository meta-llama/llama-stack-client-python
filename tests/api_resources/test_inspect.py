...
class TestInspect:
    ...
    def test_method_list_routes(self, client: LlamaStackClient) -> None:
        inspect = client.inspect.list_routes()
        assert_matches_type(InspectListRoutesResponse, inspect, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list_routes(self, client: LlamaStackClient) -> None:
        response = client.inspect.with_raw_response.list_routes()
    ...
    def test_streaming_response_list_routes(self, client: LlamaStackClient) -> None:
        with client.inspect.with_streaming_response.list_routes() as response:
...
class TestAsyncInspect:
    ...
    async def test_method_list_routes(self, async_client: AsyncLlamaStackClient) -> None:
        inspect = await async_client.inspect.list_routes()
        assert_matches_type(InspectListRoutesResponse, inspect, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list_routes(self, async_client: AsyncLlamaStackClient) -> None:
        response = await async_client.inspect.with_raw_response.list_routes()
    ...
    async def test_streaming_response_list_routes(self, async_client: AsyncLlamaStackClient) -> None:
        async with async_client.inspect.with_streaming_response.list_routes() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
