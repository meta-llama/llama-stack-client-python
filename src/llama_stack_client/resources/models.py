...
class ModelsResource(SyncAPIResource):
    ...
    def delete(
        ...
        *,
        ...
        return self._post(
            "/models/delete",
            body=maybe_transform({"model_id": model_id}, model_delete_params.ModelDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncModelsResource(AsyncAPIResource):
    ...
    async def delete(
        ...
        *,
        ...
        return await self._post(
            "/models/delete",
            body=await async_maybe_transform({"model_id": model_id}, model_delete_params.ModelDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
