...
__all__ = ["InterleavedContentParam", "ImageContentItem", "ImageContentItemImage", "TextContentItem"]
...
InterleavedContentParam: TypeAlias = Union[
    str, ImageContentItem, TextContentItem, Iterable[InterleavedContentItemParam]
]
