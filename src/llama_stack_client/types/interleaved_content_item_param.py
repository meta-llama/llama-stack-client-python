...
__all__ = ["InterleavedContentItemParam", "ImageContentItem", "ImageContentItemImage", "TextContentItem"]
...
InterleavedContentItemParam: TypeAlias = Union[ImageContentItem, TextContentItem]
